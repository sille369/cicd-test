...
LABEL Author="xiuhliu"
#LABEL Email=""
LABEL GitHub="https://git.t3.daimlertruck.com/GoDAP"
...
RUN cd /home/docker && mkdir actions-runner1 && cd actions-runner1 \
...
RUN chown -R docker ~docker && /home/docker/actions-runner1/bin/installdependencies.sh
